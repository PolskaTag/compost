...
export const ItemCategory = new Model("ItemCategory", itemCategorySchema);
...
export const CompostCategory = new Model(
  "compostCategory",
  compostCategorySchema
);
...
export const VirtualCompost = new Model("virtualCompost", virtualCompostSchema);
